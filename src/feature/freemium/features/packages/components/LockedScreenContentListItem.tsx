...
const LockedScreenContentListItem = ({content}: {content: string}) => {
  return (
    <View style={[s.py2, s.flex, s.flexRow, s.itemsStart, s.gap2, s.wFull]}>
      <View style={[s.pl6, s.hFull]}>
        <Svg
          viewBox="0 0 24 24"
          fill="none"
          height={30}
...
export default LockedScreenContentListItem;

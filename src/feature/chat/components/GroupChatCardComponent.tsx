...
import {ChatPlacerHolder, groupChatIcon, Placeholder} from '../../../assets';
...
const GroupChatCardComponent = (props: chatProps) => {
        ...
        <TouchableOpacity
          ...
          <View
            ...
            <Text style={styles.role}>
              {props.isGroup ? 'Your care group' : 'Care team'}
            </Text>
...
export default GroupChatCardComponent;

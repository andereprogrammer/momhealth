...
const PersonalSessionCardComponent: React.FC<SessionObject> = props => {
  const {setID, setShowBottomFilter, setSelectedSession, freemium} = useDataProvider();
  ...
  const animatedStyles = useAnimatedStyle(() => {
    ...
    const scale = interpolate(props.scrollX?.value, inputRange, [30, -20, 0], {
...
export default PersonalSessionCardComponent;

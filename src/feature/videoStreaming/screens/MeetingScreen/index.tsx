...
const Meeting = () => {
  ...
  const {id, patientDetails, sessionNameInfo} = useDataProvider();
...
const DisplayView = (data: {
  ...
  const navigate = useNavigation<MeetingScreenProp>();
  const dispatch = useDispatch();
  ...
  const destroy = async () => {
    await hmsInstance
      ...
      .then(s => {
        ...
        navigate.navigate('ActivityTopNavigation', {previous: 'Meeting'});
          ...
          anchor={
            <CustomButton
              ...
              LeftIcon={
                ...
                <Text style={{color: '#fff', fontSize: 12}}>Leave</Text>
              }
            />
          }
          ...
          <MenuItem
            ...
            <View style={styles.participantMenuItem}>
              <Feather
                ...
                size={iconSize}
              />
              <Text style={styles.participantMenuItemName}>Leave Session</Text>
            </View>
          </MenuItem>
